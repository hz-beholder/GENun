...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default="./outs/cifar100_-1//model_bases/cifar100_vit/ORG/cifar100_vit_seed-0_Nf-5000_ep-20_bs-256_lr-[0_0001-0_0002]_wd-5e-05_opt-Adam_trTrans-normal_tsTrans-test_regular_0.0_sched-None.pth", help='path of the model to unlearn')
    ...
    parser.add_argument('--weight_decay', type=float, default=0, help='weight decay (default: 0.0005)')
    ...
    ## 新增：金标模型路径参数
    parser.add_argument('--gold_model_path', type=str, default='./outs/cifar100_-1//model_bases/cifar100_vit/RT/cifar100_vit_seed-0_Nf-5000_ep-10_bs-256_lr-[0_0001-0_0002]_wd-5e-05_opt-Adam_trTrans-normal_tsTrans-test_regular_0.0_sched-None.pth', help='path of the gold model for evaluation metrics')
