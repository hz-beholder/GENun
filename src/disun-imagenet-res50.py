...
def parse_args():
    ...
    parser.add_argument('--out_dir', default='./outs/imagenet_-1/', help='Folder where all outputs are stored (default: .)') # 修改为tiny_imagenet
    ...
    parser.add_argument('--cuda_t', type=int, default=0, help='cuda device for teacher-model (default: 0)')
    
    ## dataset and model related parameters
    parser.add_argument('--dataset', type=str, default='imagenet',  # 修改为tiny_imagenet
    ...
    parser.add_argument('--valid_size', type=int, default=50000, metavar='V', help='number of validation samples (default: 10000)')  # 修改为10000
    parser.add_argument('--top_k', type=int, default=-1, metavar='K', help='number of selected informative samples (default: 5000)')
    parser.add_argument('--num_to_forget', type=int, default=50000, metavar='Nf', help='number of samples to forget (default: 10000)')  # 修改为10000
    ...
    parser.add_argument('--epochs', type=int, default=6, metavar='E', help='number of epochs for unlearning (default: 20)')
...
if __name__ == "__main__":
    ...
    # 设置tiny_imagenet的预训练模型路径
    args.model_path = "./outs/imagenet_-1//model_bases/imagenet_resnet50/ORG/imagenet_resnet50_seed-0_Nf-50000_ep-30_bs-512_lr-[0_0001-0_0001]_wd-5e-05_opt-Adam_trTrans-normal_tsTrans-test_regular_0.0_sched-None.pth"
    ...
    disun = DistillUnlearn(logpath, args.logname, args.out_dir)  #, out_name='model_disun'
    ...
    #                   + f"| Auc: {train_auc:.4f}, {valid_auc:.4f}, {test_auc:.4f}, {forget_auc:.4f}, {remain_auc:.4f} ###### ")
    ...
    # disun.evaluation(mod_, args.lossfn, device, 'none')
    ...
    # disun.init_student_model(mod_, init_mod_, layers_to_copy)
    # disun.preprocess(mod_, prune_amount, device)
    ...
    # disun.evaluation(unlearn_mod, args.lossfn, device, "none")
