...
if __name__ == '__main__':    
    ...
    # ****** 新增：金标模型路径 ******
    args.gold_model_path = './outs/tiny_imagenet_-1/model_bases/tiny_imagenet_resnet50/RT/tiny_imagenet_resnet50_seed-0_Nf-10000_ep-20_bs-512_lr-[1e-05-0_0001]_wd-5e-05_opt-Adam_trTrans-normal_tsTrans-test_regular_0.0_sched-None.pth'
    ...
    with torch.no_grad():
        ...
        # ZRF：学生 vs 教师（随机初始化）
        zrf_val = UnLearningScore(student_model, unlearning_teacher, forget_dl, device)
        zrf_val_best = UnLearningScore(gold_model, unlearning_teacher, forget_dl, device)
