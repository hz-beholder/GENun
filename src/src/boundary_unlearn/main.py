...
if __name__ == '__main__':
    ...
    if args.train:
        print('=' * 100)
        print(' ' * 20 + 'train original model and retrain model from scratch')
        print('=' * 100)
        ...
        print('=' * 100)
        print(' ' * 20 + 'load original model and retrain model')
        print('=' * 100)
    ...
    if args.method == 'boundary_shrink':
        print('*' * 100)
        print(' ' * 20 + 'begin boundary shrink unlearning')
        print('*' * 100)
        ...
        print('*' * 100)
        print(' ' * 20 + 'begin boundary expanding unlearning')
        print('*' * 100)
