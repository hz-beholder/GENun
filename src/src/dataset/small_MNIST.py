...
class Small_MNIST(VisionDataset):
    def __init__(self, root, num_samples=100, train=True, transform=None, target_transform=None):
...
class Small_Binary_MNIST(VisionDataset):
    def __init__(self, root, select_classes=[3, 8], num_samples=500, train=True, transform=None, target_transform=None):
