...
def parse_args():
    ...
    parser.add_argument('--out_dir', default='./outs/cifar100_-1/', help='Folder where all outputs are stored (default: .)') # 
    ...
    parser.add_argument('--seed', type=int, default=3407, metavar='S', help='random seed (default: 0)')
...
if __name__ == "__main__":
    ...
    #  resnet18_DISTILL_normal_test_none_none_adv_None_feedback_None_epochs_20_clswise_True_advreg_2.0_feedreg_30.0_seed_3407_best
